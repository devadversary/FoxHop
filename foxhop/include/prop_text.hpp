...
public:
    PropText(ID2D1RenderTarget* pRT, int MaxLength, IDWriteTextFormat* pTexFmt);
    ~PropText();
    void Init(wchar_t* pText, int nTextLen, POSITION StartPos, D2D1_COLOR_F StartColor, int StartLen);
